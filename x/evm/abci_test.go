...
func TestHandleConfirmDeposit(t *testing.T) {
	...
	givenTransferEvent := Given("a Transfer event", func(t *testing.T) {
		event = types.Event{
			Chain: sourceChainName,
			TxId:  evmTestUtils.RandomHash(),
			Index: uint64(rand.PosI64()),
	...
	burnerInfoFound := func(found bool) func(t *testing.T) {
		return func(t *testing.T) {
	...
	recipientFound := func(found bool) func(t *testing.T) {
		return func(t *testing.T) {
	...
	enqueueTransferSucceed := func(succeed bool) func(t *testing.T) {
		return func(t *testing.T) {
	...
	givenTransferEvent.
		...
		And().
		When("failed to enqueue the transfer", func(t *testing.T) {

		}).
		Then("should return false", enqueueTransferSucceed(false)).
		Run(t)
...
func TestHandleConfirmToken(t *testing.T) {
	...
	givenTokenDeployedEvent := Given("a TokenDeployed event", func(t *testing.T) {
		event = types.Event{
			Chain: sourceChainName,
			TxId:  evmTestUtils.RandomHash(),
			Index: uint64(rand.PosI64()),
	...
	canGetERC20TokenBySymbol := func(found bool) func(t *testing.T) {
		return func(t *testing.T) {
	...
	givenTokenDeployedEvent.
		When("token address in event does not match expected address", func(t *testing.T) {
			sourceCk.GetERC20TokenBySymbolFunc = func(sdk.Context, string) types.ERC20Token {
				return types.CreateERC20Token(func(meta types.ERC20TokenMetadata) {}, types.ERC20TokenMetadata{
					Status:       types.Pending,
...
func TestHandleTransferKey(t *testing.T) {
	...
	givenMultisigTransferKeyEvent := Given("a MultisigTransferKey event", func(t *testing.T) {
	...
	KeyFound := func(found bool) func(t *testing.T) {
		return func(t *testing.T) {
	...
	keyMatches := func() func(t *testing.T) {
		return func(t *testing.T) {
