...
// 			},
// 			GetPollQueueFunc: func(ctx github_com_cosmos_cosmos_sdk_types.Context) utils.GeneralKVQueue {
...
func (mock *VoterMock) GetPollQueue(ctx github_com_cosmos_cosmos_sdk_types.Context) utils.GeneralKVQueue {
